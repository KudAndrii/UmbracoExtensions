...
import type AkInputDictionaryElement from "./ak-input-dictionary.element.ts";
import './ak-input-dictionary.element.ts'

/**
 * @element ak-property-editor-ui-dictionary
 */
...
export class UmbPropertyEditorUIMultipleTextStringElement extends UmbLitElement implements UmbPropertyEditorUiElement {
	...
	@query('#input', true)
	protected _inputElement?: AkInputDictionaryElement;
...
declare global {
	interface HTMLElementTagNameMap {
		'ak-property-editor-ui-dictionary': UmbPropertyEditorUIMultipleTextStringElement;
	}
}
