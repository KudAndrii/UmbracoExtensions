...
/**
 * @element input-multiple-key-value-pair-item
 */
@customElement('input-multiple-key-value-pair-item')
export class UmbInputMultipleKeyValuePairItemElement extends UUIFormControlMixin(UmbLitElement, '') {
    /**
     * Disables the input
     * @type {boolean}
     * @attr
    ...
    constructor() {
        super();
        console.debug('log from input-multiple-key-value-pair-item.element');
    }
...
export default UmbInputMultipleKeyValuePairItemElement;

declare global {
    interface HTMLElementTagNameMap {
        'input-multiple-key-value-pair-item': UmbInputMultipleKeyValuePairItemElement;
    }
}
