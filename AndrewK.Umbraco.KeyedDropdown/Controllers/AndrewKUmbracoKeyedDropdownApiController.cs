...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "AndrewK.Umbraco.KeyedDropdown")]
    public class AndrewKUmbracoKeyedDropdownApiController : AndrewKUmbracoKeyedDropdownApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public AndrewKUmbracoKeyedDropdownApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
