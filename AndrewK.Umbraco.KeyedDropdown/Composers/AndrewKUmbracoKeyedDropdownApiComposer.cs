...
namespace AndrewK.Umbraco.KeyedDropdown.Composers
{
    public class AndrewKUmbracoKeyedDropdownApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Andrew KUmbraco Keyed Dropdown Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<AndrewKUmbracoKeyedDropdownOperationSecurityFilter>();
            });
        }

        public class
            AndrewKUmbracoKeyedDropdownOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
                ...
                ControllerActionDescriptor controllerActionDescriptor)
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith(
                    "AndrewK.Umbraco.KeyedDropdown.Controllers",
