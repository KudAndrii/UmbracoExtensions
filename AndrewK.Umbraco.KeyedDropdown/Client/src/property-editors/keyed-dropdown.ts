 ...
 */
@customElement('keyed-dropdown-property-editor-ui')
export class KeyedDropdownElement extends UmbLitElement implements UmbPropertyEditorUiElement {
...
export default KeyedDropdownElement;

declare global {
    interface HTMLElementTagNameMap {
        'keyed-dropdown-property-editor-ui': KeyedDropdownElement;
    }
}
