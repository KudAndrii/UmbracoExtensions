...
import { AndrewKUmbracoKeyedDropdownService, UserModel } from "../api";
...
export class ExampleDashboardElement extends UmbElementMixin(LitElement) {
  ...
  #onClickWhoAmI = async (ev: Event) => {
    ...
    const { data, error } = await AndrewKUmbracoKeyedDropdownService.whoAmI();
  ...
  #onClickWhatsTheTimeMrWolf = async (ev: Event) => {
    ...
    const { data, error } = await AndrewKUmbracoKeyedDropdownService.whatsTheTimeMrWolf();
  ...
  #onClickWhatsMyName = async (ev: Event) => {
    ...
    const { data, error } = await AndrewKUmbracoKeyedDropdownService.whatsMyName();
